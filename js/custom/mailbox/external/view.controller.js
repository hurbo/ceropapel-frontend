(function () {
  ...
  angular
    ...
    .controller('ExternalMailViewController', ExternalMailViewController);

  ExternalMailViewController.$inject = ['$scope', 'ViewDocumentFactory', '$q', '$rootScope', 'DocumentFactory', 'EditorFactory'];

  function ExternalMailViewController($scope, ViewDocumentFactory, $q, $rootScope, Doc, EditorFactory) {
    var vm = this;
    vm.needReload = false;
    ...
    $scope.$on('watch-reload-view-inbox', function (event, data) {
