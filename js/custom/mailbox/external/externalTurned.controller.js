...
(function () {
  ...
  angular.module('app.mailbox').controller('externalTurnedController', externalTurnedController);

  externalTurnedController.$inject = [
    'socket',
    '$rootScope',
    'paginatorFactory',
    'filterFactory',
  ...
  function externalTurnedController(
    socket,
    $rootScope,
    paginatorFactory,
    filterFactory,
    ...
    function activate() {
      ...
      ExternalsFactory.validatePermision('readTurned').then(function (can) {
        if (can) {
          ...
          Profile.getProfile().then(function (profile) {
            ...
            vm.paginator.init('externalTurned');
          }, function (err) {
